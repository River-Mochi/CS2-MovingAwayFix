namespace CS2-MovingAwayFix
{
    ...
    public class Setting : ModSetting
    {
        ...
        public bool ButtonWithConfirmation
        {
            set
            {
                Mod.log.Info("ButtonWithConfirmation clicked");
            }
        }
        ...
        public ProxyBinding KeyboardBinding
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding MouseBinding
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding GamepadBinding
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding FloatBindingNegative
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding FloatBindingPositive
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding Vector2BindingDown
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding Vector2BindingUp
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding Vector2BindingLeft
        {
            get; set;
        }
        ...
        [SettingsUISection(kSection, kKeybindingGroup)]
        public ProxyBinding Vector2BindingRight
        {
            get; set;
        }
